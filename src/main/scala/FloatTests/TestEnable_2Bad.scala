...
@spatial object TestEnable_2Bad extends SpatialApp {
  //@virtualize
  def main(args: Array[String]): Unit = {
    ...
    val data3 = Array.tabulate[T](16.to[I32])(i => i.to[T])
...
//print after init
    ...
    val re = getArg(y)
    val gold = getArg(x) + data0(7.to[I32]) + data1(7.to[I32]) + data2(7.to[I32]) + data3(7.to[I32])
